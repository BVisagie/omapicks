...
Plugins must be installable and point to an HTTPS repository. A curated taxonomy can place one plugin in more than one app type when it genuinely belongs in both.
